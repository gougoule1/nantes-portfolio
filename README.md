# Portfolio Demo — Sites Vitrines Nantes

Dépôt contenant 3 sites démonstration pour prospection web à Nantes.
...
Ces sites sont prêts à être déployés sur GitHub Pages.
...
Drag & drop chaque dossier sur [app.netlify.com/drop](https://app.netlify.com/drop)
...
- **Pas de build requis** — fichiers statiques prêts à l'emploi

## Note

Ces sites sont des **démonstrations** (fakes), pas des sites clients réels. Ils servent à illustrer le niveau de qualité livrable lors de projets de création de sites vitrines.
